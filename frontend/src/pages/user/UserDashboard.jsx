...
//   // Check for state passed from "Create Ticket" link
//   useEffect(() => {
//     if (location.state?.createTicket) {
//       setShowCreateModal(true);
//       // Pre-fill form with resource information if provided
//       if (location.state.resourceId) {
//         setNewTicket(prev => ({
//           ...prev,
//           resourceId: location.state.resourceId,
//           title: location.state.resourceName ? `Issue with ${location.state.resourceName}` : prev.title,
//         }));
//       }
//     }
//   }, [location]);
...
//       // Add required fields
//       formDataToSend.append('title', newTicket.title);
//       formDataToSend.append('description', newTicket.description);
//       formDataToSend.append('category', newTicket.category);
//       formDataToSend.append('priority', newTicket.priority);
//       formDataToSend.append('location', newTicket.location);
//       formDataToSend.append('contactDetails', newTicket.contactDetails);
//       formDataToSend.append('preferredContactMethod', newTicket.preferredContactMethod);
      
//       // Add resource ID if selected
//       if (newTicket.resourceId) {
//         formDataToSend.append('resourceId', newTicket.resourceId);
//       }
...
//       await ticketAPI.createTicket(formDataToSend);
...
//         <p className="text-gray-600">Manage your tickets and create new support requests</p>
//       </div>
